    ...
    <section id="container">
      <div class="row">
        <div class="col-md-2" id="left_sidebar">
          <img src="images/avtar.jpeg" class="img-rounded" width="200px" height="200px">
        ...
        <div class="col-md-8" id="main_content">
          ...
          <p>
          This is the user Dashboard page. Here user can mangage notice board system. He can create a notice, delete a notice and all the replies of the notice.</p>
          <p>
          This is the user Dashboard page. Here user can mangage notice board system. He can create a notice, delete a notice and all the replies of the notice.</p>
          <p>
          This is the user Dashboard page. Here user can mangage notice board system. He can create a notice, delete a notice and all the replies of the notice.</p>
